...
from src.utils.storage.utils import generate_filename, ensure_directory_exists, read_json_file, write_json_file
    ...
    def initialize_file(self, initial_data: Optional[Dict[str, Any]] = None) -> Path:
        ...
        try:
            if self.current_file and self.current_file.exists():
                ...
                read_json_file(self.current_file)  # Validate file is readable
