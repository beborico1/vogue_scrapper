...
class VogueSeasonsHandler:
    ...
    def get_seasons_list(self) -> List[Dict[str, str]]:
        ...
        try:
            ...
            self.logger.info(f"Total seasons found: {len(seasons)}")
            return seasons
    ...
    def _get_navigation_groups(self) -> List:
        ...
        nav_groups = self.driver.find_elements(
            By.CLASS_NAME, SELECTORS['navigation_wrapper']
        )
    ...
    def _get_year(self, nav_group) -> str:
        ...
        year_elem = nav_group.find_element(
            By.CLASS_NAME, SELECTORS['navigation_heading']
        )
    ...
    def _get_seasons_for_year(self, nav_group, year: str) -> List[Dict[str, str]]:
        ...
        seasons = []
        links = nav_group.find_elements(
            By.CLASS_NAME, SELECTORS['navigation_link']
        )
        ...
        for link in links:
            ...
            self.logger.info(
                f"Found season: {season_data['season']} {season_data['year']}"
            )
